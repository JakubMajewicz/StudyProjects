<!DOCTYPE html>
    ...
    <form class="form-inline" action="<?=config('app.url'); ?>/modulescrew/save" method="post">
    @csrf
    <p>
        <label for="nick">Nick:</label>
        <input id="nick" name="nick" size="10" required>
    </p>
    <p>
    ...
    <input type="number" id="age" name="age" size="2" required>
    </p>
